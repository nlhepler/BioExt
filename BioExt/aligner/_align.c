/* Generated by Cython 0.18 on Thu Mar 14 14:07:58 2013 */
...
static PyObject *__pyx_pw_6BioExt_7aligner_6_align_1choose(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("choose (wrapper)", 0);
  {
    ...
    __pyx_v_n = __Pyx_PyInt_from_py_npy_long(values[0]); if (unlikely((__pyx_v_n == (npy_long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_k = __Pyx_PyInt_from_py_npy_long(values[1]); if (unlikely((__pyx_v_k == (npy_long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
...
static PyObject *__pyx_pw_6BioExt_7aligner_6_align_5_align(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_align (wrapper)", 0);
  {
    ...
    __pyx_v_char_count = __Pyx_PyInt_from_py_npy_long(values[2]); if (unlikely((__pyx_v_char_count == (npy_long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_char_map = ((PyArrayObject *)values[3]);
    __pyx_v_cost_matrix = ((PyArrayObject *)values[4]);
    __pyx_v_cost_stride = __Pyx_PyInt_from_py_npy_long(values[5]); if (unlikely((__pyx_v_cost_stride == (npy_long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    ...
    __pyx_v_do_local = __Pyx_PyInt_from_py_npy_long(values[11]); if (unlikely((__pyx_v_do_local == (npy_long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_do_affine = __Pyx_PyInt_from_py_npy_long(values[12]); if (unlikely((__pyx_v_do_affine == (npy_long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_do_codon = __Pyx_PyInt_from_py_npy_long(values[13]); if (unlikely((__pyx_v_do_codon == (npy_long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
